...
describe("ui api", function() {
    ...
    describe("icon handler", function() {
        ...
        it.skip('returns the default icon when getting an unknown icon', function(done) {
        ...
        it.skip('returns a known icon', function(done) {
    ...
    describe("editor ui resource handler", function() {
        ...
        it.skip('serves the editor resources', function(done) {
            request(app)
                .get("/favicon.ico")
                .expect(200)
                .end(function(err,res) {
