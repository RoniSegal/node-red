...
describe('tail Node', function() {
    ...
    it.skip('should be loaded', function(done) {
    ...
    it.skip('should tail a file', function(done) {
    ...
    it.skip('should work in non-split mode', function(done) {
    ...
    it.skip('should work in binary mode', function(done) {
    ...
    it.skip('should handle a non-existent file', function(done) {
